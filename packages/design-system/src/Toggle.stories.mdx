...
// Small toggle
<Toggle size="sm" aria-label="Toggle notifications">
  <Bell className="h-3 w-3" />
</Toggle>

// Toolbar toggles
<div className="flex items-center space-x-1">
  <Toggle pressed={format.bold} onPressedChange={toggleBold}>
    <Bold className="h-4 w-4" />
  </Toggle>
  <Toggle pressed={format.italic} onPressedChange={toggleItalic}>
    <Italic className="h-4 w-4" />
  </Toggle>
  <Toggle pressed={format.underline} onPressedChange={toggleUnderline}>
