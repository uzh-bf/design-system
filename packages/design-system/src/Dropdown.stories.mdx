...
{/* START README */}
The Dropdown component provides an abstracted component interface for a dropdown menu that is styled similar to other Shadcn components to fit into the design-system. It supports both simple items, radio groups, checkboxes, and submenus, while the trigger can be customized.
