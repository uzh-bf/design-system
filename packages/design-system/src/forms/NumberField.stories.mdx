...
- Stepper: Compact number field with increment/decrement controls
...
- step?: number - Increment/decrement amount for stepper controls
- stepper?: boolean - Render compact controls around the numeric input
