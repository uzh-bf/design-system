...
{/* START README */}
The `Table` component currently represents a simple re-export of the Shadcn UI Table component. More information on the structure can be found on the [Shadcn UI Table documentation](https://ui.shadcn.com/docs/components/table).
{/* END README */}
