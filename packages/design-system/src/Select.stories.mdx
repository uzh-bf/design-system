...
- Select (from @uzh-bf/design-system/primitives): raw shadcn select primitives
    ...
    <div className="h-12 w-full rounded-md border border-solid">
      <Select
        ...
        className={{
          ...
          trigger:
            'bg-primary-20 rounded-none border-none text-lg data-placeholder:text-primary-100',
          item: 'text-destructive-text',
          groupLabel: 'text-destructive-text',
