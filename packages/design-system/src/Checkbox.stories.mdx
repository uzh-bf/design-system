...
**Note**: This is distinct from the raw shadcn Checkbox (available from `@uzh-bf/design-system/primitives`), offering additional features like sizing, partial states, and enhanced label integration.
