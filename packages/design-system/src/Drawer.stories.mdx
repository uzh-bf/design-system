...
<Drawer>
  <DrawerTrigger asChild>
    <Button variant="outline">Select Amount</Button>
  </DrawerTrigger>
  <DrawerContent>
    <div className="mx-auto w-full max-w-sm">
      <DrawerHeader>
        <DrawerTitle>Choose Amount</DrawerTitle>
      </DrawerHeader>
      <div className="p-4">
...
// With snap points
<Drawer snapPoints={[0.2, 0.5, 0.8]}>
  <DrawerTrigger asChild>
    <Button>Open Expandable Drawer</Button>
  </DrawerTrigger>
  <DrawerContent>
    <div className="p-4 h-96">
      <DrawerHeader>
        <DrawerTitle>Expandable Content</DrawerTitle>
      </DrawerHeader>
      <div className="space-y-4">
        {/* Content that adapts to different snap heights */}
      </div>
    </div>
  </DrawerContent>
</Drawer>
