...
The toast trigger function is an abstraction of the sonner-based Shadcn UI Toast component, providing a simple way to create toast notifications with customizable content and actions. Additionally, it offers three pre-styled toast types: success, warning, and error.
