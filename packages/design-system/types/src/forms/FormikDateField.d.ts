 ...
 */
export declare function FormikDateField({ id, data, name, label, labelType, placeholder, tooltip, required, hideError, disabled, className, ...props }: DateFieldProps): import("react/jsx-runtime").JSX.Element;
