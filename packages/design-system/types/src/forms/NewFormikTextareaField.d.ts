...
export interface FormikTextareaFieldWithNameProps extends FormikTextareaFieldProps {
    name: string;
    value?: never;
    onChange?: never;
    error?: never;
...
export interface FormikTextareaFieldWithOnChangeProps extends FormikTextareaFieldProps {
    name?: never;
    value: string;
 ...
 */
export declare function FormikTextareaField({ id, data, name, value, onChange, error, label, labelType, icon, onIconClick, placeholder, tooltip, required, hideError, disabled, className, ...props }: FormikTextareaFieldWithNameProps | FormikTextareaFieldWithOnChangeProps): import("react/jsx-runtime").JSX.Element;
