...
declare global {
    interface HTMLDfContainerElement extends Components.DfContainer, HTMLStencilElement {
    }
    var HTMLDfContainerElement: {
        prototype: HTMLDfContainerElement;
        new (): HTMLDfContainerElement;
    };
    ...
    interface HTMLElementTagNameMap {
        "df-container": HTMLDfContainerElement;
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            "df-container": LocalJSX.DfContainer & JSXBase.HTMLAttributes<HTMLDfContainerElement>;
