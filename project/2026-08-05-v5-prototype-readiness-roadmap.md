...
- 2026-08-09: Sol's earlier integrated final review passed exact range `origin/v5..62adbf2785f4f159ee6a79009eecbdcdf5bda8c4`; subsequent commits `f5f6fc83a` and `272254dffc` changed the reviewed scope, so that readiness statement is superseded. The corrected final DS review is pending, and alpha.3 remains unpublished.
