...
- 2026-08-09: alpha.3 release inputs prepared without a tag or publication; superseded local packed artifacts had SHA-256 `64ea1b607d5815e2e7e04fc1a500a8628f218c68ec5ce1c647cbe16d4c2b1935`, `7b0e2afa162766be83efa51937f295878faa600b8f0e147a0f3f387173007917`, `cc610844b26609c96e4a667b4dfb43b85c338fa3a7bcc36b71130b2f0986f317`, `0b1cec1db7e348b0c8e5be96af32973536fd2b6c40135bbb049e8edb09afa1d9`, `c3ba4b5cd5521f62720d06295da80f805ad980911829f7b45c5147b77e627814`, and the pre-documentation artifact `401de1040c4f4a6b3b550da3692713b6a4690f46d275baf2d4339d9d155340b5`. The initial package proof passed 1,278 tests, 18 focused RHF/multi-select accessibility checks, and a scratch consumer; named `setValue` and `resetField` updates now replace stale number buffers.
- 2026-08-09: final release-proof coverage now passes 1,288 full-suite tests, 15 focused RHF contract tests, and 22 focused RHF/multi-select accessibility checks. It directly verifies negative and lower-bound number behavior plus exact-once blur callbacks for closed, Escape, pointer-outside, and internal-focus composite paths. The final alpha.3 tarball is SHA-256 `5f9e003a3c77511af00c7e0fb9bb08447a872a5b02417bec86f423647d35fd5f`; a fresh scratch consumer type-checks, server-renders both RHF control modes, resolves the supported exports, and rejects `/ui` and `/forms`. No tag or publication was created.
- 2026-08-09: the exact-range final-suite review caught and closed a nondeterministic Select pointer-outside assertion by synchronizing the reopened trigger and using explicit body/outside pointer targets. Test commit `e6e4fdde6` and the current documentation tip retain 1,288 of 1,288 package tests; DS final review is rerunning against the current exact tip.
- 2026-08-09: final review type probes found that runtime FormProvider context cannot infer generic field paths. The DS docs now require explicit controls for compile-time value safety, JSX declarations cover valid and invalid explicit-control calls, and number-only demo-game models are recorded for `number | ''` boundary normalization. Correction committed as `08674087c`; DS final review is rerunning after this public-contract clarification.
- 2026-08-09: Sol's earlier integrated final review passed exact range `origin/v5..62adbf2785f4f159ee6a79009eecbdcdf5bda8c4`; subsequent commits `f5f6fc83a`, `272254dffc`, and `7daefb699` changed the reviewed scope, so that readiness statement is superseded. The corrected final DS review passed exact range `origin/v5..7daefb699` with no findings, and alpha.3 remains unpublished.
