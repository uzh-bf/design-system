...
- Next: push, PR + deliberate-red CI proof (VRT must block build), merge into v5, then Package B (fold hand-written Unreleased CHANGELOG into the generated alpha.5 entry; STOP before tag push).
