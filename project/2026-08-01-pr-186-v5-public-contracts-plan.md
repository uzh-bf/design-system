...
- 2026-08-02: Draft [PR #186](https://github.com/uzh-bf/design-system/pull/186)
  and dependent [PR #187](https://github.com/uzh-bf/design-system/pull/187)
  were published through the native stack flow. Both target the `v5` release
  line; the empty A3 placeholder remains local and unsubmitted.
