...
- Current slice: S4 next.
- Next action: refine Avatar/Checkbox/Progress/Select/Separator/Skeleton/Switch/Table/Label visuals to UZH spec (sizes, hoverable rows, header style).
